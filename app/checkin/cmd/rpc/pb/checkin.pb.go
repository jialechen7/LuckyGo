...
var file_app_checkin_cmd_rpc_pb_checkin_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x73, 0x32, 0xb8, 0x07, 0x0a, 0x07, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x69, 0x6e, 0x12,
	...
	0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x52, 0x65, 0x73, 0x70, 0x42, 0x06,
...
var file_app_checkin_cmd_rpc_pb_checkin_proto_depIdxs = []int32{
	...
	2,  // 23: pb.checkin.AddCheckinRecord:output_type -> pb.AddCheckinRecordResp
	4,  // 24: pb.checkin.UpdateCheckinRecord:output_type -> pb.UpdateCheckinRecordResp
	6,  // 25: pb.checkin.GetCheckinRecordByUserId:output_type -> pb.GetCheckinRecordByUserIdResp
	9,  // 26: pb.checkin.AddIntegral:output_type -> pb.AddIntegralResp
	16, // 27: pb.checkin.AddIntegralRecord:output_type -> pb.AddIntegralRecordResp
	20, // 28: pb.checkin.DelIntegralRecord:output_type -> pb.DelIntegralRecordResp
	34, // 29: pb.checkin.AddTaskRecord:output_type -> pb.AddTaskRecordResp
	36, // 30: pb.checkin.UpdateTaskRecord:output_type -> pb.UpdateTaskRecordResp
	38, // 31: pb.checkin.DelTaskRecord:output_type -> pb.DelTaskRecordResp
	42, // 32: pb.checkin.GetTaskRecordByUserId:output_type -> pb.GetTaskRecordByUserIdResp
	47, // 33: pb.checkin.AddTasks:output_type -> pb.AddTasksResp
	51, // 34: pb.checkin.DelTasks:output_type -> pb.DelTasksResp
	29, // 35: pb.checkin.GetTaskProgress:output_type -> pb.GetTaskProgressResp
	31, // 36: pb.checkin.UpdateSub:output_type -> pb.UpdateSubResp
